...
import static org.example.HistoryNode.getHistoryTransaction;
import static org.example.QueueHistory.historyQueue;
import static org.example.RekeningNode.*;
import static org.example.RekeningNode.transfer;

public class JenisOperasi {
    ...
    public static void loginSuccess(String noRekening, List<String> data) {
        boolean end = false;
        while (!end) {
            try {
                System.out.println("\nMenu Utama:");
